...
DEFAULT_FILE_STORAGES = 'config.storages.MediaStorage'   # 기본 스토리지
STATICFILES_STORATGES = 'config.storages.StaticStorage'   # 이 두 줄을 작성하고 나면 static root, media root 줄은 필요 없어진다.
